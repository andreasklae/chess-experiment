...
_SYSTEM_PROMPT_EXTRA = (
    ...
    "'two-rook-ladder-mate', 'king-rook-mate'). IMMEDIATELY read the page it names BEFORE doing anything else. "
    "For example, if the radar says 'read mates/two-rook-ladder-mate.md', call "
    "`read_reference(skill_name=\"chess\", path=\"mates/two-rook-ladder-mate.md\")` and study the "
